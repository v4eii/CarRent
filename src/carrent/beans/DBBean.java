...
public class DBBean {
    ...
    //<editor-fold defaultstate="collapsed" desc="Äèàëîãîâûå îêíà">
    
    public void showErrDialog(Throwable ex, String header, String content)
    {
        ExceptionDialog dialog = new ExceptionDialog(ex);
        dialog.setTitle("Îøèáêà");
    ...
    public void showWarningDialog(String header, String content)
    {
        ...
        dialog.initStyle(StageStyle.UTILITY);
        dialog.setHeaderText(header);
        dialog.setTitle("Ïðåäóïðåæäåíèå");
        if (!content.isEmpty())
            dialog.setContentText(content);
    ...
    //<editor-fold defaultstate="collapsed" desc="Ãåòòåðû êîíòðîëëåðîâ">
